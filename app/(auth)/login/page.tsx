...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br  from-slate-950 via-slate-900 to-slate-950">
      <div className="absolute inset-0 bg-[url('/football-pattern.svg')] bg-repeat opacity-[0.05]"></div>
          ...
          <div className="text-center space-y-8">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3">
                ...
                <h1 className="text-xl md:text-4xl font-bold bg-linear-to-r from-green-400 to-green-500 bg-clip-text text-transparent">
                  FootballDebate
                </h1>
              </div>
            ...
            <div className="w-full max-w-md mx-auto">
              <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-700 shadow-2xl shadow-black/50 p-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div className="group p-5 rounded-2xl bg-slate-800/80 backdrop-blur-sm border border-slate-700 hover:shadow-lg hover:shadow-green-500/10 transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="group p-5 rounded-2xl bg-slate-800/80 backdrop-blur-sm border border-slate-700 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="group p-5 rounded-2xl bg-slate-800/80 backdrop-blur-sm border border-slate-700 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 hover:-translate-y-1">
                <div className="w-12 h-12 rounded-xl bg-linear-to-br from-purple-500 to-purple-600 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
...
//                   />
//                 </div>
//                 <h1 className="text-xl md:text-4xl font-bold bg-linear-to-r from-green-700 to-green-600 dark:from-green-400 dark:to-green-500 bg-clip-text text-transparent">
//                   FootballDebate
//                 </h1>
//               </div>

...
import { MAIN_EMAIL } from "@/lib/utils";
import { ArrowLeft, MoveLeft, MoveRightIcon } from "lucide-react";
      ...
      <div className="bg-card rounded-lg shadow-sm p-6 md:p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              Welcome to PredictOcean ("we", "us", "our", or "the Service").
              These Terms and Conditions ("Terms") govern your use of our
              football prediction platform, including all related services,
              features, and content.
            </p>
            <p>
              By accessing or using PredictOcean, you agree to be bound by these
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              By using our Service, you represent and warrant that you are at
              least 13 years of age and have the legal capacity to enter into
              these Terms.
            </p>
            <p>
              If you are under 18 years of age, you represent and warrant that
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              Our Service allows you to submit, post, and share content
              including predictions, comments, and other materials ("User
              Content"). By submitting User Content, you grant PredictOcean a
              worldwide, non-exclusive, royalty-free license to use, reproduce,
              modify, adapt, publish, translate, create derivative works from,
              distribute, and display such content.
            </p>
            <p>
              You retain ownership of your User Content and are responsible for
              it. You represent that your User Content does not violate any
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 mb-3">
              ...
              <li>
                Post content that is unlawful, offensive, threatening,
                defamatory, or otherwise objectionable
              </li>
              <li>
                Engage in any automated use of the system, such as using scripts
                to send comments or predictions
              </li>
              <li>
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              ...
              are owned by PredictOcean and are protected by international
          ...
          <section className="mb-6">
            ...
            <p>
              In no event shall PredictOcean, nor its directors, employees,

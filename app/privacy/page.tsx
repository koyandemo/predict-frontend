...
export const metadata: Metadata = {
  ...
  description:
    "Learn how PredictOcean collects, uses, and protects your personal information.",
};
      ...
      <div className="bg-card rounded-lg shadow-sm p-6 md:p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              PredictOcean ("we", "us", "our", or "the Service") is committed to
              protecting your privacy. This Privacy Policy explains how we
              collect, use, disclose, and safeguard your information when you
              visit our football prediction platform at
              https://www.predictocean.com ("Site").
            </p>
            <p>
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              We may collect information about you in various ways when you use
              our Service:
            </p>

...
export const metadata: Metadata = {
  ...
  description:
    "Learn how PredictOcean uses cookies to enhance your experience on our platform.",
};
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              ...
              what information they gather, how we use it, and some of the ways
              in which you can manage them.
            </p>
            <p>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 mb-3">
              <li>
                <strong>Authentication:</strong> To remember your login status
                and provide access to protected areas
              </li>
              <li>
              ...
              <li>
                <strong>Analytics:</strong> To analyze how visitors interact
                with our website
              </li>
              <li>
              ...
              <li>
                <strong>Performance:</strong> To measure and improve the
          ...
          <section className="mb-6">
            ...
            <p className="mb-3">
              We may use third-party services that use cookies for various
              purposes:
            </p>
            <ul className="list-disc pl-6 mb-3">
              <li>
                <strong>Analytics:</strong> Google Analytics and similar
                services to analyze website traffic
              </li>
              <li>
                <strong>Advertising:</strong> Google AdSense and other
                advertising networks
              </li>
              <li>
                <strong>Social Media:</strong> Facebook, Twitter, and other
                social media platforms
              </li>
              <li>
                <strong>Payment Processors:</strong> For processing payments
                securely
              </li>
            </ul>
            <p>
              These third parties may use cookies to track your online
              activities over time and across different websites for advertising
              purposes.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p>
              ...
              time by adjusting your browser settings or using the cookie
